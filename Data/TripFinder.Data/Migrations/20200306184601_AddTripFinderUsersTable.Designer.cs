...
namespace TripFinder.Data.Migrations
{
    ...
    [Migration("20200306184601_AddTripFinderUsersTable")]
    partial class AddTripFinderUsersTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TripFinder.Data.Models.TripFinderUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("TripFinder.Data.Models.Car", b =>
                {
                    b.HasOne("TripFinder.Data.Models.TripFinderUser", "Owner")
                        .WithOne("Car")
            ...
            modelBuilder.Entity("TripFinder.Data.Models.Review", b =>
                {
                    b.HasOne("TripFinder.Data.Models.TripFinderUser", "ReviewedUser")
                        .WithMany("ReviewsByUser")
                        .HasForeignKey("ReviewedUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("TripFinder.Data.Models.TripFinderUser", "Reviewer")
            ...
            modelBuilder.Entity("TripFinder.Data.Models.TripFinderUser", b =>
                {
                    b.HasOne("TripFinder.Data.Models.ApplicationUser", "ApplicationUser")
                        .WithOne("User")
                        .HasForeignKey("TripFinder.Data.Models.TripFinderUser", "ApplicationUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("TripFinder.Data.Models.UserTrip", b =>
                {
                    ...
                    b.HasOne("TripFinder.Data.Models.TripFinderUser", "User")
                        .WithMany("UserTrips")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
